        ...
        <div x-show="mobileMenuOpen"
            ...
            <div class="mt-6 flow-root">
                <div class="-my-6 divide-y divide-slate-200">
                    ...
                    <div class="py-6">
                        <a href="https://wa.me/628122709648" target="_blank" @click="mobileMenuOpen = false" class="flex items-center justify-center gap-2 w-full rounded-full px-3 py-3 text-base font-bold leading-7 text-white bg-[#25D366] hover:bg-[#128C7E] shadow-lg transition-all">
