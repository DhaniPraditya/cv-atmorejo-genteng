        ...
        <div x-show="mobileMenuOpen"
            ...
            <div class="mt-6 flow-root">
                <div class="-my-6 divide-y divide-slate-200">
                    ...
                    <div class="py-6">
                        <a href="https://wa.me/6281234567890" target="_blank" @click="mobileMenuOpen = false" class="-mx-3 rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-white bg-[#25D366] hover:bg-[#128C7E] flex items-center justify-center gap-2 mt-4 shadow-md transition-colors">
